...
<sup id="fn1">1. The 7 entity types include assignees, CPC subsections, inventors, locations, NBER subcategories, patents, and USPC main classes.<a href="#ref1">↩</a></sup>

<sup id="fn2">2. Note, this particular webpage includes some details that are not relevant to the `query` argument, such as the field list and sort parameter.<a href="#ref2">↩</a></sup>