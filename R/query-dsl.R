...
#'   qry_funs$or(
#'     qry_funs$eq(inventors.inventor_last_name = "Ihaka"),
#'     qry_funs$eq(inventors.inventor_first_name = "Chris")
#'   )
#' )
#'
...
#'    or(
#'      eq(inventors.inventor_last_name = "Ihaka"),
#'      eq(inventors.inventor_first_name = "Chris")
#'    )
#'  )
#' )
#'
