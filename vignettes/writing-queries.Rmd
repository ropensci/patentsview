...
`search_pv` will check your query and throw a helpful error message if you provide your query as a list (methods 2 or 3). This is not the case for method 1, were you would have to rely on the API's error messages for guidance...`search_pv` will check list queries for the following:
